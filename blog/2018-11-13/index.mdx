---
date: "2018-11-13"
title: "A Simple Next.js Markdown blog"
categories:
    - Web
    - React
    - Next.js
...
In this post I'm going to show how to make blog using [Markdown](https://en.wikipedia.org/wiki/Markdown) and [Next.js](https://nextjs.org/).
...
```
The `getInitialProps` function gets posts from posts folder and returns them in a usable format. *We are going to use your file name as our post's slug or id*
